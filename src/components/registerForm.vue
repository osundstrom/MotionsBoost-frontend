...
//funktion för att skapa nytt konto
    async registerFunc() {
        ...
        let errorDiv = document.getElementById("errorDiv"); //felmeddelanden
        ...
        throw new Error("Fyll i samtliga fält"); 
      ...
      //Väntar svar och till JSON
        ...
        this.$router.push("/");
            ...
            console.error(error);
            errorDiv.textContent = error.message || "Ett fel inträffade";   
        }
    }
...
<form @submit.prevent="registerFunc" class="container-md">
  ...
  <div class="mb-3">
    ...
    <input type="firstname" class="form-control" id="InputFirstName" aria-describedby="firstnameHelp" placeholder="Förnamn">

  </div>

  <div class="mb-3"> 
    <label for="inputLastName" class="form-label">Efternamn</label>
    <input type="lastname" class="form-control" id="InputLastName" aria-describedby="lastnameHelp" placeholder="Efternamn">
