  ...
  <div class="SectionTwo">
    <form @submit.prevent="createChallenge" class="container-md">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="InputChallengeName" v-model="challengeName"
          placeholder="Ange utmaningens namn" required />
      </div>


      <div class="mb-3">
        <label for="InputTargetSteps" class="form-label">Stegmål</label>
        <input type="number" class="form-control" id="InputTargetSteps" v-model.number="targetSteps"
          placeholder="Ange antal steg" required min="1" />
      </div>
